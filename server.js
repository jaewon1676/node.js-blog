...
const LocalStrategy = require('passport-local').Strategy; // passport-local 라이브러리
const session = require('express-session'); // express-session 라이브러리

app.use(session({secret : '비밀코드', resave : true, saveUnitialized : false}));
